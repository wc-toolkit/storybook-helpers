...
- aaf62c2: Scope the empty-string default fallback to workaround controls only
...
- 3f4e6f7: Fix regression where args without a default value were omitted entirely
